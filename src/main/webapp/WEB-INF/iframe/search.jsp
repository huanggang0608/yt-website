                            ...
                            <div class="srchsongst">
                                <c:forEach items="${musicList}" var="music">
                                    <div class="item f-cb h-flag  ">
                                        <div class="td">
                                            <div class="hd"><a href="javascript:void(0);" id="song_482999668" class="ply " title="播放"
                                                               data-res-copyright="1" data-res-type="18" data-res-id="482999668"
                                                               data-res-action="play" data-res-from="32" data-res-data="${music.musicName}"
                                        ...
                                        <div class="td">
                                            <div class="opt hshow"><a class="u-icn u-icn-81 icn-add" href="javascript:;"
                                                                      ...
                                                                      data-res-data="${musci.musicName}" onclick="window.parent.way('${music.musicId}','${music.musicName}','${music.singerName}',false)"></a>
