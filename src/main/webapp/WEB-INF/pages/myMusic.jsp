                                        ...
                                        <tr id="4529863511555838920284" class=" ">
                                            <td class="left">
                                                <div class="hd "><span data-res-id="452986351" data-res-type="18"
                                                                       ...
                                                                       data-res-data="475407140" class="ply ply2" onclick="way('${music.musicId}','${music.musicName}','${music.singerName}',true)">&nbsp;</span><span
                                            ...
                                            <td class=" s-fc3"><span class="u-dur candel">${music.musicTime}</span>
                                                <div class="opt hshow">
                                                    <a class="u-icn u-icn-81 icn-add" href="javascript:;"
                                                                          ...
                                                                          data-res-from="13" data-res-data="475407140" onclick="way('${music.musicId}','${music.musicName}','${music.singerName}',false)"></a>
...
<%--<iframe name="contentFrame" id="g_iframe" class="g-iframe" scrolling="auto" frameborder="0" src="/index.jsp" allowfullscreen="true">
    <p>no</p>>
</iframe>--%>
    ...
    $(function(){
      ...
      <!--预先写入播放列表 -->
       /* song = [
            ...
            %>
            {
                'cover' : 'music/images/<%=MyMusic.getmusicname(i,1)%>.jpg',
                'src' : 'music/mp3/<%=MyMusic.getmusicname(i,1)%>.mp3',
